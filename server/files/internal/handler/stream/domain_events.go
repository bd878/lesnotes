...
func (h domainHandler[T]) onFileUploaded(ctx context.Context, event ddd.Event) error {
	...
	return h.stream.Publish(ctx, events.FilesChannel, am.NewEventMessage(event.ID(), events.FileUploadedEvent, data, event.Metadata()))
}
...
func (h domainHandler[T]) onFilesDeleted(ctx context.Context, event ddd.Event) error {
	...
	return h.stream.Publish(ctx, events.FilesChannel, am.NewEventMessage(event.ID(), events.FilesDeletedEvent, data, event.Metadata()))
}
...
func (h domainHandler[T]) onFilesPrivated(ctx context.Context, event ddd.Event) error {
	...
	return h.stream.Publish(ctx, events.FilesChannel, am.NewEventMessage(event.ID(), events.FilesPrivatedEvent, data, event.Metadata()))
}
...
func (h domainHandler[T]) onFilesPublished(ctx context.Context, event ddd.Event) error {
	...
	return h.stream.Publish(ctx, events.FilesChannel, am.NewEventMessage(event.ID(), events.FilesPublishedEvent, data, event.Metadata()))
}
