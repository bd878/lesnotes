...
func (h *Handler) ReadTreeJsonAPI(w http.ResponseWriter, req *http.Request) (err error) {
	...
	var request model.ReadTreeRequest
	...
	response, err := json.Marshal(model.ReadTreeResponse{
		List:  tree,
	})
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
