...
func (c *Controller) CreateSession(ctx context.Context, userID int64) (session *model.Session, err error) {
...
func (c *Controller) ListUserSessions(ctx context.Context, userID int64) ([]*model.Session, error) {
...
func (c *Controller) RemoveUserSessions(ctx context.Context, userID int64) error {
