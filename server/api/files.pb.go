...
var file_protos_files_proto_rawDesc = []byte{
	...
	0x74, 0x50, 0x61, 0x67, 0x65, 0x32, 0xf6, 0x02, 0x0a, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12,
	...
	0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x25,
...
var file_protos_files_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_protos_files_proto_goTypes = []interface{}{
	...
	nil,                            // 10: files.v1.ReadBatchFilesResponse.FilesEntry
}
var file_protos_files_proto_depIdxs = []int32{
	0,  // 0: files.v1.FileData.file:type_name -> files.v1.File
	10, // 1: files.v1.ReadBatchFilesResponse.files:type_name -> files.v1.ReadBatchFilesResponse.FilesEntry
	...
	0,  // 9: files.v1.Files.ReadFile:output_type -> files.v1.File
	7,  // 10: files.v1.Files.ReadBatchFiles:output_type -> files.v1.ReadBatchFilesResponse
	3,  // 11: files.v1.Files.SaveFileStream:output_type -> files.v1.SaveFileStreamResponse
	2,  // 12: files.v1.Files.ReadFileStream:output_type -> files.v1.FileData
	9,  // 13: files.v1.Files.ListFiles:output_type -> files.v1.ListFilesResponse
