...
const (
	...
	Files_PublishFiles_FullMethodName     = "/files.v1.Files/PublishFiles"
	Files_PrivateFiles_FullMethodName     = "/files.v1.Files/PrivateFiles"
	Files_DeleteFiles_FullMethodName      = "/files.v1.Files/DeleteFiles"
	Files_ReadMessageFiles_FullMethodName = "/files.v1.Files/ReadMessageFiles"
)
...
func (c *filesClient) PublishFiles(ctx context.Context, in *PublishFilesRequest, opts ...grpc.CallOption) (*PublishFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Files_PublishFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filesClient) PrivateFiles(ctx context.Context, in *PrivateFilesRequest, opts ...grpc.CallOption) (*PrivateFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Files_PrivateFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filesClient) DeleteFiles(ctx context.Context, in *DeleteFilesRequest, opts ...grpc.CallOption) (*DeleteFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Files_DeleteFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filesClient) ReadMessageFiles(ctx context.Context, in *ReadMessageFilesRequest, opts ...grpc.CallOption) (*ReadMessageFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Files_ReadMessageFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFilesServer) ReadBatchFiles(context.Context, *ReadBatchFilesRequest) (*ReadBatchFilesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadBatchFiles not implemented")
}
func (UnimplementedFilesServer) SaveFileStream(grpc.ClientStreamingServer[FileData, SaveFileStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method SaveFileStream not implemented")
}
...
func (UnimplementedFilesServer) PublishFiles(context.Context, *PublishFilesRequest) (*PublishFilesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PublishFiles not implemented")
}
func (UnimplementedFilesServer) PrivateFiles(context.Context, *PrivateFilesRequest) (*PrivateFilesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PrivateFiles not implemented")
}
...
func (UnimplementedFilesServer) ReadMessageFiles(context.Context, *ReadMessageFilesRequest) (*ReadMessageFilesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadMessageFiles not implemented")
}
...
func _Files_PublishFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Files_PublishFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Files_PrivateFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Files_PrivateFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Files_DeleteFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Files_DeleteFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Files_ReadMessageFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Files_ReadMessageFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
