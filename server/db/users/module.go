...
import (
	...
	"github.com/bd878/gallery/server/db/users/config"
	...
	"github.com/bd878/gallery/server/db/users/internal/controller/distributed"
	"github.com/bd878/gallery/server/db/users/internal/handler/grpc"
)
...
func Root(ctx context.Context, cfg config.Config, svc system.Service) (err error) {
	...
	users.RegisterUsersServer(svc.RPC(), handler)
