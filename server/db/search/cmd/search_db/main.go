...
import (
	...
	"github.com/bd878/gallery/server/db/search"
	"github.com/bd878/gallery/server/db/search/migrations"
...
func main() {
	...
	fmt.Println("starting search db")
	defer fmt.Println("stopped search db")
