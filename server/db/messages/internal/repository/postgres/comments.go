...
func (r *CommentsRepository) Read(ctx context.Context, id, userID int64) (comment *comments.Comment, err error) {
...
func (r *CommentsRepository) ListMessageComments(ctx context.Context, messageID int64, limit, offset int32) (result *comments.CommentsList, err error) {
	var tx pgx.Tx
	tx, err = r.pool.BeginTx(ctx, pgx.TxOptions{})
	if err != nil {
		return
