...
import (
	...
	"github.com/bd878/gallery/server/db/messages"
	"github.com/bd878/gallery/server/db/messages/config"
	"github.com/bd878/gallery/server/db/messages/migrations"
)
...
func main() {
	...
	fmt.Println("starting messages db")
	defer fmt.Println("stopped messages db")
