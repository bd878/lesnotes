...
func New(conf Config) *Server {
	...
	mux.Handle("/threads/v2/publish", middleware.Build(handler.PublishThreadJsonAPI))
	mux.Handle("/threads/v2/private", middleware.Build(handler.PrivateThreadJsonAPI))
