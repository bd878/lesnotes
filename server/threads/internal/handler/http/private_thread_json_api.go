...
func (h *Handler) PrivateThreadJsonAPI(w http.ResponseWriter, req *http.Request) (err error) {
	...
	var request threads.PrivateThreadRequest
	...
	err = h.privateThread(w, req, user, request.ID)
