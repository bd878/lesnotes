...
func (h domainHandler[T]) onThreadCreated(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadCreatedEvent, data, event.Metadata(), events.ThreadsChannel))
}
...
func (h domainHandler[T]) onThreadDeleted(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadDeletedEvent, data, event.Metadata(), events.ThreadsChannel))	
}
...
func (h domainHandler[T]) onThreadPrivated(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadPrivatedEvent, data, event.Metadata(), events.ThreadsChannel))	
}
...
func (h domainHandler[T]) onThreadUpdated(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadUpdatedEvent, data, event.Metadata(), events.ThreadsChannel))	
}
...
func (h domainHandler[T]) onThreadPublished(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadPublishedEvent, data, event.Metadata(), events.ThreadsChannel))	
}
...
func (h domainHandler[T]) onThreadParentChanged(ctx context.Context, event ddd.Event) error {
	...
	return h.publisher.Publish(ctx, events.ThreadsChannel, am.NewRawMessage(event.ID(), events.ThreadParentChangedEvent, data, event.Metadata(), events.ThreadsChannel))		
}
