...
const file_threads_internal_machine_commands_proto_rawDesc = "" +
	"\n" +
	"'threads/internal/machine/commands.proto\"\xab\x02\n" +
	...
	"\x03ids\x18\x01 \x03(\x03R\x03ids\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x03R\x06userIdB:Z8github.com/bd878/gallery/server/threads/internal/machineb\x06proto3"

var (
	file_threads_internal_machine_commands_proto_rawDescOnce sync.Once
	file_threads_internal_machine_commands_proto_rawDescData []byte
)
...
func file_threads_internal_machine_commands_proto_rawDescGZIP() []byte {
	file_threads_internal_machine_commands_proto_rawDescOnce.Do(func() {
		file_threads_internal_machine_commands_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_threads_internal_machine_commands_proto_rawDesc), len(file_threads_internal_machine_commands_proto_rawDesc)))
	})
...
var file_threads_internal_machine_commands_proto_goTypes = []any{
...
func file_threads_internal_machine_commands_proto_init() {
	...
	file_threads_internal_machine_commands_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_threads_internal_machine_commands_proto_rawDesc), len(file_threads_internal_machine_commands_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
