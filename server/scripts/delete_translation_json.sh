...
stage=${STAGE:-"stage."}
token=${1?:"Usage: delete_translation_json.sh token message_id lang"}
messageID=${2?:"Usage: delete_translation_json.sh token message_id lang"}
lang=${3?:"Usage: delete_translation_json.sh token message_id lang"}
