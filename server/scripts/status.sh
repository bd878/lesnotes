...
STAGE["threads"]="https://stage.lesnotes.space/threads/v1/status"
# TODO: add http endpoint, then STAGE["sessions"]="https://stage.lesnotes.space/sessions/v1/status"
...
PROD["threads"]="https://lesnotes.space/threads/v1/status"
# PROD["sessions"]="https://lesnotes.space/sessions/v1/status"
