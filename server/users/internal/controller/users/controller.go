...
type Repository interface {
	Save(ctx context.Context, id int64, login, salt, theme, lang string) (err error)
	Delete(ctx context.Context, id int64) (err error)
	Find(ctx context.Context, id int64, login string) (*model.User, error)
	Update(ctx context.Context, id int64, newLogin, newTheme, newLang string) (err error)
}
...
func (c *Controller) UpdateUser(ctx context.Context, id int64, newLogin, newTheme, newLang string) (err error) {
	logger.Debugw("update user", "login", newLogin, "theme", newTheme, "lang", newLang)

	err = c.repo.Update(ctx, id, newLogin, newTheme, newLang)
