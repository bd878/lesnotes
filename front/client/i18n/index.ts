const texts = {
	"en": {
		...
		descriptionPlaceholder: "Description of public thread",
		thread: "Thread",
		note: "Note",
		themeHeader: "Theme",
		langHeader: "Language",
	...
	"ru": {
		...
		descriptionPlaceholder: "Описание публичного списка",
		thread: "Тред",
		note: "Заметка",
	...
	"de": {
		...
		descriptionPlaceholder: "Offentlich list Beschreibung",
		thread: "List",
		note: "Notiz",
	...
	"fr": {
		...
		descriptionPlaceholder: "La description de la publique liste",
		thread: "Liste",
		note: "Note",
